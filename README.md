...
yoyo Plugin 启动后会解锁插件入口，并在会话列表悬停时显示删除按钮：

![yoyo Plugin 解锁插件入口并添加删除按钮](docs/images/solution-plugin-and-delete.png)

顶部菜单栏会出现 `yoyo Plugin`，可以查看后端状态并打开设置面板：

![yoyo Plugin 后端状态指示灯](docs/images/backend-status-indicator.png)
![yoyo Plugin 设置面板](docs/images/settings-panel.png)
...
![macOS 提示 yoyo Plugin 管理工具已损坏](docs/images/macos-damaged-warning.png)
