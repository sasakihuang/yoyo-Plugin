...
export const EN_PLAIN: Record<string, string> = {
  ...
  "正在检查官方远端插件缓存…": "Checking official remote plugin cache…",
  "正在读取本地远端插件快照…": "Reading local remote plugin snapshot…",
  ...
  "缓存官方账号模式可见但本地快照缺失的插件，API 模式也可显示和安装。":
    "Caches plugins visible in official-account mode but missing from the local snapshot, so API mode can also show and install them.",
  ...
  "日志已复制。": "Logs copied.",
  "时间": "Time",
  "注册远端插件缓存": "Register remote plugin cache",
  ...
  "未发现官方远端插件缓存，请先用官方账号安装或缓存一次。": "Official remote plugin cache not found. Install or cache once with an official account first.",
  "未注册": "Not registered",
  "未知": "Unknown",
  "未知作者": "Unknown author",
  "未知来源": "Unknown source",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "官方远端插件缓存需要注册或尚未缓存。": "Official remote plugin cache needs registration or has not been cached yet.",
  "官方远端插件缓存已可用。": "Official remote plugin cache is available.",
  "未发现官方远端插件缓存，请先用官方账号缓存一次。": "Official remote plugin cache not found. Cache it once with an official account first.",
